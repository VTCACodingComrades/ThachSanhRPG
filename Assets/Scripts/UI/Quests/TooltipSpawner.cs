...
namespace GameDevTV.Core.UI.Tooltips
{
    ...
    /// data.
    /// </summary>
    public abstract class TooltipSpawner : MonoBehaviour, IPointerExitHandler, IPointerDownHandler
    {
        // CONFIG DATA
        [Tooltip("The prefab of the tooltip to spawn.")]
        [SerializeField] GameObject tooltipPrefab = null;
        [SerializeField] Transform tooltipSpawingPos;
        ...
        //        //tooltip = Instantiate(tooltipPrefab,tooltipSpawingPos);
        //    }
        ...
        private void PositionTooltip1()
        {
            ...
            //tooltip.transform.position =  tooltip.transform.position + new Vector3(-20,-20);
        }
